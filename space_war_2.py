...
laser_green_img = pygame.image.load('assets/images/laserRed.png').convert_alpha()
laser_red_img = pygame.image.load('assets/images/laserGreen.png').convert_alpha()
enemy_img = pygame.image.load('assets/images/enemy.png').convert_alpha()
enemy_img = pygame.transform.scale(enemy_img, (50, 40))
space_img = pygame.image.load('assets/images/space_background.png').convert()
...
class Ship(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        hit_list_2 = pygame.sprite.spritecollide(self, bullets,True,pygame.sprite.collide_mask)
...
class Mob(pygame.sprite.Sprite):
    ...
    def update(self):
        hit_list_1 = pygame.sprite.spritecollide(self, lasers, True, pygame.sprite.collide_mask)
...
class Bullet(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        self.image = pygame.transform.rotate(laser_green_img, math.degrees(self.theta))
...
class Fleet2():
    ...
    def make_sentrys(self):
        sentrys.add(Sentry(50, HEIGHT * (4/10), sentry_img))
        sentrys.add(Sentry(WIDTH - 100, HEIGHT * (4/10), sentry_img))
...
def setup():
    ...
    ''' Make game objects '''
    ship = Ship(WIDTH/2, HEIGHT - 150, ship_img)
...
def end_game():
    ...
    score_txt = FONT_LG.render(str(player.score), 1, WHITE)
    score_txt_width = score_txt.get_width()
    score_txt_height = score_txt.get_height()
    screen.blit(score_txt, [(1/2*WIDTH - 1/2*score_txt_width), ((1/2*HEIGHT - 1/2*score_txt_height)+100)])

def draw_wave(wave):
    wave_txt = FONT_LG.render("Wave:" + str(wave), 1, WHITE)
    screen.blit(wave_txt, [17, HEIGHT - 100])
